...
int main(void) {
    ...
    // PWM from Timer 2 to OC5
    OC5CONbits.OCM = 6;
    OC5CONbits.OCTSEL = 0; // 0=temporizador 2, 1=temporizador 3
    OC5RS = ((PR2 + 1) * 50 + 50) / 100; // duty=duty cycle pretendido=50%
    OC5CONbits.ON = 1;
    ...
    while(1) {
        ...
        OC3RS = ((PR2 + 1) * (100-duty) + 50) / 100; // duty=duty cycle pretendido
